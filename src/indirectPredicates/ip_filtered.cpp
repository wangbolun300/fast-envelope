...
bool ip_filtered::orient3D_LPI_prefilter(
...
int ip_filtered::orient3D_LPI_postfilter(
	...
	const double& cx, const double& cy, const double& cz)
{
	...
	if (::fetestexcept(FE_UNDERFLOW | FE_OVERFLOW | FE_INVALID)) return ip_filtered::Filtered_Orientation::UNCERTAIN_POSITION; // Fast reject in case of under/overflow
...
bool ip_filtered::orient3D_TPI_prefilter(
...
int ip_filtered::orient3D_TPI_postfilter(
